...
void main() {
  group('login', () {
   ...
   test('playingGame', () async {
    ...
    await driver.scroll(element1, 0.0, -500.0, const Duration(milliseconds:400 ));
    await driver.scroll(element2, -300.0, -500.0, const Duration(milliseconds:400 ));
    await driver.scroll(element3, 0.0, -250.0, const Duration(milliseconds:400 ));
    await driver.scroll(element4, 0.0, -500.0, const Duration(milliseconds:400 ));
