INSERT INTO `card` (id, type, title, header, content, option) VALUES ('lion', 2, 'Lion', 'assets/topic/Lion_waiting_in_Namibia.jpg', NULL, NULL);
...
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('giraffe', 2, 'Giraffe', 'assets/topic/animals-2870416_960_720.jpg', NULL, NULL);
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('bear', 2, 'Bear', 'assets/topic/bear.jpg', NULL, NULL);
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('zebra', 2, 'Zebra', 'assets/topic/zebra-1422083_960_720.jpg', NULL, NULL);
...
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('elephant', 2, 'Elephant', 'assets/topic/10006-an-elephant-in-the-wild-pv.jpg', NULL, NULL);
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('rhino', 2, 'Rhinoceros', 'assets/topic/indian_rhino_by_8twilightangel8-d6ffwyv.jpg', NULL, NULL);
...
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_stripes', 'template', 1, 'assets/topic/309914.svg');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_stripes', 'template', 2, 'assets/topic/2722150-3f51b5.svg');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_stripes', 'template', 3, 'assets/topic/Tiger_clipart.svg');
...
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_roar', 'template', 1, 'assets/topic/animal-animal-photography-big-cat-792381.jpg');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_roar', 'template', 2, 'assets/topic/Siberischer_tiger_de_edit02.jpg');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_roar', 'template', 3, 'assets/topic/tiger-2519637_960_720.jpg');
...
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('tiger_countries', 0, 'Select the countries where tigers are found', 'assets/topic/Tigers.png', NULL, 'many');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_countries', 'answer', 1, 'India');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_countries', 'answer', 2, 'Bangladesh');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_countries', 'answer', 3, 'China');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_countries', 'answer', 4, 'Thailand');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_countries', 'choice', 1, 'Tanzania');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_countries', 'choice', 2, 'Russia');
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('tiger_small_big', 0, 'Select the animals from small to big', 'assets/topic/jungle-animals-colorful-art.jpg', NULL, 'many');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_small_big', 'answer', 1, 'tiger cub');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_small_big', 'answer', 2, 'pig');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_small_big', 'answer', 3, 'deer');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_small_big', 'answer', 4, 'buffalo');
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('tiger_fur_color', 0, 'What is the color of the tiger''s fur?', 'assets/topic/Flickr_-_law_keven_-_Tiger,_Tiger,_Burning_bright.jpg', NULL, 'oneAtATime');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_fur_color', 'answer', 1, 'orange');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_fur_color', 'choice', 1, 'orange');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_fur_color', 'choice', 2, 'green');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_fur_color', 'choice', 3, 'violet');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_fur_color', 'choice', 4, 'pink');
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('tiger_body_parts', 0, 'Match the body parts with the adjective', 'assets/topic/tiger_sleep.jpeg', NULL, 'pair');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 1, 'fur');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 2, 'striped');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 3, 'jaws');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 4, 'strong');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 5, 'paws');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 6, 'soft');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 7, 'claws');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 8, 'sharp');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 9, 'whiskers');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_body_parts', 'answer', 10, 'long');
INSERT INTO `card` (id, type, title, header, content, option) VALUES ('tiger_swimmer', 0, 'Tigers are superb swimmers', 'assets/topic/24868494306_84d2fd285b_b.jpg', NULL, 'oneAtATime');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_swimmer', 'answer', 1, 'true');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_swimmer', 'choice', 1, 'true');
INSERT INTO `cardExtra` (cardId, type, serial, content) VALUES ('tiger_swimmer', 'choice', 2, 'false');
