...
class _ScoreScreenState extends State<ScoreScreen> with TickerProviderStateMixin {
  ...
  Animation<double> _buttonAnimation, _characterAnimation, _userAnimation, _textAnimation;
  ...
  @override
    void initState() {
      ...
      _buttonAnimation = new CurvedAnimation(parent: controller, curve: Curves.bounceInOut);
      _characterAnimation = new CurvedAnimation(parent: controller, curve: Curves.bounceOut);
