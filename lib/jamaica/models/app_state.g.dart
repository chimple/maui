...
class _$AppState extends AppState {
  ...
  _$AppState._({this.isLoading, this.userProfile}) : super._() {
    if (isLoading == null) {
      throw new BuiltValueNullFieldError('AppState', 'isLoading');
    }
    if (userProfile == null) {
      throw new BuiltValueNullFieldError('AppState', 'userProfile');
    }
  }
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, isLoading.hashCode), userProfile.hashCode));
  }
...
class AppStateBuilder implements Builder<AppState, AppStateBuilder> {
  ...
  _$AppState build() {
    ...
    try {
      _$result = _$v ??
          new _$AppState._(
              isLoading: isLoading, userProfile: userProfile.build());
    } catch (_) {
