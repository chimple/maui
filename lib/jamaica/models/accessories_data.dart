...
Map<AccessoryCategory, List<AccessoryData>> list = {
  AccessoryCategory('assets/accessories/alphabet.png', 'Hat'): [
    ...
    AccessoryData('assets/accessories/head_acc/head1', 'hat12', 100),
    AccessoryData('assets/accessories/head_acc/head2', 'hat13', 100),
    AccessoryData('assets/accessories/head_acc/head3', 'hat14', 100),
    AccessoryData('assets/accessories/head_acc/head4', 'hat15', 100),
    AccessoryData('assets/accessories/head_acc/head5', 'hat16', 100),
    AccessoryData('assets/accessories/head_acc/head6', 'hat17', 100),
    AccessoryData('assets/accessories/head_acc/head7', 'hat18', 100),
    AccessoryData('assets/accessories/head_acc/head8', 'hat19', 100),
    AccessoryData('assets/accessories/head_acc/head9', 'hat20', 100),
    AccessoryData('assets/accessories/head_acc/head10', 'hat21', 100),
  ],
