...
import 'package:maui/l10n/messages_en.dart';
...
class ParentAccess extends StatefulWidget {
  ...
  @override
  _ParentAccessState createState() => _ParentAccessState();
}

class _ParentAccessState extends State<ParentAccess> {
  String _answer = "";
  String _showAnswer = "";
  int _rightAnswer;
  ...
  String getTheQuestion(BuildContext context, String num1, String num2) {
    final language = new MessageLookup();
    String word1, word2;
