...
///
/// Used by [CustomRenderEditable.onSelectionChanged].
typedef CustomSelectionChangedHandler = void Function(TextSelection selection,
    CustomRenderEditable renderObject, CustomSelectionChangedCause cause);

/// Indicates what triggered the change in selected text (including changes to
/// the cursor location).
enum CustomSelectionChangedCause {
...
///
/// Used by [CustomRenderEditable.onCaretChanged].
typedef CustomCaretChangedHandler = void Function(Rect caretRect);

/// Represents the coordinates of the point in a selection, and the text
/// direction at that point, relative to top left of the [CustomRenderEditable] that
/// holds the selection.
@immutable
class CustomTextSelectionPoint {
  /// Creates a description of a point in a text selection.
  ///
  /// The [point] argument must not be null.
  const CustomTextSelectionPoint(this.point, this.direction)
      : assert(point != null);

  /// Coordinates of the lower left or lower right corner of the selection,
  /// relative to the top left of the [CustomRenderEditable] object.
  final Offset point;
...
class CustomRenderEditable extends RenderBox {
  ...
  CustomRenderEditable({
    ...
    @required this.textSelectionDelegate,
        ...
        assert(textDirection != null,
            'CustomRenderEditable created without a textDirection.'),
  ...
  CustomSelectionChangedHandler onSelectionChanged;
  CustomSelectionChangedHandler onSelectionStart;
  double _textLayoutLastWidth;

  /// Called during the paint phase when the caret location changes.
  CustomCaretChangedHandler onCaretChanged;
    ...
    if (shift) {
      if (_baseOffset < newOffset) {
        onSelectionChanged(
          ...
          this,
          CustomSelectionChangedCause.keyboard,
        );
      } else {
        onSelectionChanged(
  ...
  void _handleSetSelection(TextSelection selection) {
    onSelectionChanged(selection, this, CustomSelectionChangedCause.keyboard);
  }
  ...
  List<CustomTextSelectionPoint> getEndpointsForSelection(
      TextSelection selection) {
    ...
    if (selection.isCollapsed) {
      ...
      return <CustomTextSelectionPoint>[CustomTextSelectionPoint(start, null)];
    } else {
      ...
      return <CustomTextSelectionPoint>[
        CustomTextSelectionPoint(start, boxes.first.direction),
        CustomTextSelectionPoint(end, boxes.last.direction),
      ];
    }
  }
  ...
  void handleDoubleTap() {
    selectWord(cause: CustomSelectionChangedCause.doubleTap);
  }
  ...
  void handleLongPress() {
    selectWord(cause: CustomSelectionChangedCause.longPress);
  }
  ...
  /// {@endtemplate}
  void selectPosition({@required CustomSelectionChangedCause cause}) {
  ...
  ///
  /// {@macro flutter.rendering.editable.select}
  void selectWordEdge({@required CustomSelectionChangedCause cause}) {
    assert(cause != null);
    _layoutText(constraints.maxWidth);
