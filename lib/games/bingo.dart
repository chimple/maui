...
////        }
    ...
    animationDance = new Tween(begin: 1.2, end: 1.0).animate(
      new CurvedAnimation(
        parent: controller2,
        curve: new Interval(
          0.100,
    ...
    animationOpacity = new Tween(begin:0.9,end:0.4 ).animate(new CurvedAnimation(parent: controller2,
        curve:new Interval(0.520, 1.0,curve:new Cubic(400.0, 400.0, 400.0, 400.0))));
