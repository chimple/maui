...
todnumbers.forEach((e){e.forEach((v){_todnumber.add(v);});});
 ...
 code = rng.nextInt(499) + rng.nextInt(500);
  ...
  Widget _buildItem(int index,String  text, Status status,ShakeCell tile,Offset offset,bool vflag) {
 ...
 print("hello data coming or not in widgets is $_letters");
   ...
   print("how head to head is working");
    ...
    final hPadding = pow(constraints.maxWidth / 150.0, 2);
      ...
      print("object full screen width is ......:$fullwidthofscreen..........=${media.size.height}");
