...
class Loca {
  ...
  // String get teddy bear => Intl.message('teddy bear', name: 'teddy bear');
  ...
  // String get microwave oven => Intl.message('microwave oven', name: 'microwave oven');
  ...
  // String get upper body => Intl.message('upper body', name: 'upper body');
  // String get right hand => Intl.message('right hand', name: 'right hand');
  // String get left hand => Intl.message('left hand', name: 'left hand');
  // String get right palm => Intl.message('right palm', name: 'right palm');
  // String get left palm => Intl.message('left palm', name: 'left palm');
  // String get right leg => Intl.message('right leg', name: 'right leg');
  // String get left leg => Intl.message('left leg', name: 'left leg');
  // String get right foot => Intl.message('right foot', name: 'right foot');
  // String get left foot => Intl.message('left foot', name: 'left foot');
