...
import 'package:maui/widgets/story/custom_editable.dart';
...
/// [TextEditingValue] for the purposes of a [CustomTextSelectionOverlay]. The
/// [caretRect] argument gives the location of the caret in the coordinate space
/// of the [RenderBox] given by the [CustomTextSelectionOverlay.renderObject].
///
/// Used by [CustomTextSelectionOverlay.onSelectionOverlayChanged].
typedef CustomTextSelectionOverlayChanged = void Function(
...
abstract class CustomTextSelectionControls {
...
class CustomTextSelectionOverlay {
  ...
  final CustomRenderEditable renderObject;

  /// Builds text selection handles and toolbar.
  final CustomTextSelectionControls selectionControls;
  ...
  Widget _buildToolbar(BuildContext context) {
    ...
    final List<CustomTextSelectionPoint> endpoints =
...
class _TextSelectionHandleOverlayState
  ...
  TextSelectionHandleType _chooseType(CustomTextSelectionPoint endpoint,
