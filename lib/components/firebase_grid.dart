...
class FirebaseAnimatedGrid extends StatefulWidget {
  /// Creates a scrolling container that animates items when they are inserted or removed.
  FirebaseAnimatedGrid({
    Key key,
    @required this.query,
  ...
  @override
  FirebaseAnimatedGridState createState() => new FirebaseAnimatedGridState();
}
...
class FirebaseAnimatedGridState extends State<FirebaseAnimatedGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    return new GridView.count(
      ...
      crossAxisCount: 3,
      children: _model
          .map((f) => widget.itemBuilder(context, f))
