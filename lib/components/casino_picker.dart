...
import 'casino_scroll_view.dart';
...
class CasinoPicker extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new _CasinoPickerState();
}

class _CasinoPickerState extends State<CasinoPicker> {
  ...
  Widget build(BuildContext context) {
    Widget result = new Stack(
      children: <Widget>[
        new Positioned.fill(
          child: new CasinoScrollView(
            controller: widget.scrollController,
            physics: const CasinoScrollPhysics(),
